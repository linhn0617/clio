...
**預編譯（推薦）** —— 從 [最新 release](https://github.com/linhn0617/clio/releases/latest)（目前為 [**v0.11.0**](https://github.com/linhn0617/clio/releases/tag/v0.11.0)；macOS/Linux `amd64`+`arm64`、Windows `amd64`）下載你平台的檔案，放進 `PATH`，並用 `SHASUMS256.txt` 驗證。

**或用 `go install`：**

```
go install github.com/linhn0617/clio/cmd/clio@v0.11.0   # 或用 @latest 取得最新
```
